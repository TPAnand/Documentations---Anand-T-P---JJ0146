...
define(['N/record', 'N/runtime', 'N/search', 'N/ui/serverWidget', 'N/url'],
    ...
    (record, runtime, search, serverWidget, url) => {
        // var CLIENT_SCRIPT_FILE_ID = 4512; // Sandbox file ID
        ...
        const getCustomerDataArray=(salesRep,savedSearch, category, customerGrade,trainingGrade) => {
            try {
                ...
                if((savedSearch && savedSearch != 0) && ((salesRep && salesRep != 0) || (category && category!=0) || (customerGrade && customerGrade!=0) || (trainingGrade && trainingGrade!=0))){
                    ...
                    var grade = search.createColumn({name: "custrecord_jj_customer_grades", join: "CUSTRECORD_JJ_CUST_PLNGRM_PARENT", label: "Grade"});
                    var trGrade = search.createColumn({ name: 'custrecord_jj_customer_grades_planogram',join:'CUSTRECORD_JJ_CUST_PLNGRM_PARENT', label: "Training Grade"})
                    ...
                    var customerSearchObj = search.create({
                        ...
                        columns:
                            [
                                ...
                                search.createColumn({name: "custrecord_jj_customer_grades", join: "CUSTRECORD_JJ_CUST_PLNGRM_PARENT", label: "Training Grade"}),
                                search.createColumn({name: "custrecord_jj_customer_grades_planogram", join: "CUSTRECORD_JJ_CUST_PLNGRM_PARENT", label: "Customer Grades "}),
